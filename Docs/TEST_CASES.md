...
- A sentence naming a place and a time is held in Needs review and neither trigger fires until the person chooses, whether the place is saved ("Remind me to feed the dog when I get home tonight", "…when I get home Friday") or named ("When I go to Sobeys, remind me to get cheese, eggs, and bread in one hour", "…tomorrow when I get to Costco"). Both single-half readings are wrong in a way the person would feel. Until 2026-09-23 a named place let the time win and was dropped; that was the arrival condition executing unconditionally, and it is now held (DEL-18). The store still names the list, and the list stays one row, as any place-triggered list does. The delay may also sit inside the place clause ("When I go to Sobeys in an hour…") with the same reading. Place-only sentences keep their place trigger unchanged, and "remind me at <clock>" ("at lunch", "at half five") is still a time, not a place.
...
- On launch, items held in review for a place and a time stay held: no pass restores their clock or drops their place. (Until 2026-09-23 a launch pass released named-place holds; it was removed with DEL-18.) A stored row that constrains a place and a time and still carries a clock is not scheduled until the person reviews or edits it.
