...
| utterances | share of 6,018 | population |
|---:|---:|---|
| 4,181 | 69.5% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,918 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,018, is a
total.
...
114, so the three kinds are 4,181 + 1,333 + 618 = 6,132 against a union of
6,018 and do not add up. Written out so that they do:

| kind | utterances | share of 6,018 |
|---|---:|---:|
| test fixtures only | 4,067 | 67.6% |
| generated renderings (the SpeechLab tree) | 1,333 | 22.2% |
| development sets only | 504 | 8.4% |
| in both a development set and a fixture | 114 | 1.9% |
| **total** | **6,018** | |

**91.6% of everything this project may read — 5,514 of 6,018 — is either a
