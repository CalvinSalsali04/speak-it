...
| utterances | share of 5,991 | population |
|---:|---:|---|
| 4,154 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,891 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,991, is a
total.
...
114, so the three kinds are 4,154 + 1,333 + 618 = 6,105 against a union of
5,991 and do not add up. Written out so that they do:

| kind | utterances | share of 5,991 |
|---|---:|---:|
| test fixtures only | 4,040 | 67.4% |
...
**91.6% of everything this project may read — 5,487 of 5,991 — is either a
