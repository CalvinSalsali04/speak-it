...
| utterances | share of 5,997 | population |
|---:|---:|---|
| 4,160 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,897 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,997, is a
total.
...
114, so the three kinds are 4,160 + 1,333 + 618 = 6,111 against a union of
5,997 and do not add up. Written out so that they do:

| kind | utterances | share of 5,997 |
|---|---:|---:|
| test fixtures only | 4,046 | 67.5% |
...
**91.6% of everything this project may read — 5,493 of 5,997 — is either a
