...
| utterances | share of 5,996 | population |
|---:|---:|---|
| 4,159 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,896 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,996, is a
total.
...
114, so the three kinds are 4,159 + 1,333 + 618 = 6,110 against a union of
5,996 and do not add up. Written out so that they do:

| kind | utterances | share of 5,996 |
|---|---:|---:|
| test fixtures only | 4,045 | 67.5% |
...
**91.6% of everything this project may read — 5,492 of 5,996 — is either a
