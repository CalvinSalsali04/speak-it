...
| utterances | share of 5,909 | population |
|---:|---:|---|
| 4,072 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,809 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,909, is a
total.
...
114, so the three kinds are 4,072 + 1,333 + 618 = 6,023 against a union of
5,909 and do not add up. Written out so that they do:

| kind | utterances | share of 5,909 |
|---|---:|---:|
| test fixtures only | 3,958 | 67.0% |
...
**91.5% of everything this project may read — 5,405 of 5,909 — is either a
