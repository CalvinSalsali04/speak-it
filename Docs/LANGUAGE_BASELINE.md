...
| utterances | share of 6,255 | population |
|---:|---:|---|
| 4,418 | 70.6% | the gating corpus in `SpeakItTests` |
| 818 | 13.1% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 11.1% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
...
**That column sums to 7,155 and its shares to 114.4%, because the twelve
...
additional maximal population that contains it. Only the union, 6,255, is a
total.
...
114, so the three kinds are 4,418 + 1,333 + 618 = 6,369 against a union of
6,255 and do not add up. Written out so that they do:

| kind | utterances | share of 6,255 |
|---|---:|---:|
| test fixtures only | 4,304 | 68.8% |
| generated renderings (the SpeechLab tree) | 1,333 | 21.3% |
| development sets only | 504 | 8.1% |
| in both a development set and a fixture | 114 | 1.8% |
| **total** | **6,255** | |

**91.9% of everything this project may read — 5,751 of 6,255 — is either a
