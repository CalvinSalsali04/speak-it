...
| utterances | share of 5,986 | population |
|---:|---:|---|
| 4,149 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,886 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,986, is a
total.
...
114, so the three kinds are 4,149 + 1,333 + 618 = 6,100 against a union of
5,986 and do not add up. Written out so that they do:

| kind | utterances | share of 5,986 |
|---|---:|---:|
| test fixtures only | 4,035 | 67.4% |
...
**91.6% of everything this project may read — 5,482 of 5,986 — is either a
