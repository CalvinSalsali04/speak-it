...
| utterances | share of 6,874 | population |
|---:|---:|---|
| 5,038 | 73.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,775 and its shares to 113.1%, because the twelve
...
additional maximal population that contains it. Only the union, 6,874, is a
total.
...
115, so the three kinds are 5,038 + 1,333 + 618 = 6,989 against a union of
6,874 and do not add up. Written out so that they do:

| kind | utterances | share of 6,874 |
|---|---:|---:|
| test fixtures only | 4,923 | 71.6% |
...
**92.7% of everything this project may read — 6,371 of 6,874 — is either a
