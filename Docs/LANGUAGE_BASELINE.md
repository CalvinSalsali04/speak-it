...
| utterances | share of 5,979 | population |
|---:|---:|---|
| 4,142 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,879 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,979, is a
total.
...
114, so the three kinds are 4,142 + 1,333 + 618 = 6,093 against a union of
5,979 and do not add up. Written out so that they do:

| kind | utterances | share of 5,979 |
|---|---:|---:|
| test fixtures only | 4,028 | 67.4% |
...
**91.6% of everything this project may read — 5,475 of 5,979 — is either a
