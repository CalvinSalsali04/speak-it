...
| utterances | share of 5,915 | population |
|---:|---:|---|
| 4,078 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,815 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,915, is a
total.
...
114, so the three kinds are 4,078 + 1,333 + 618 = 6,029 against a union of
5,915 and do not add up. Written out so that they do:

| kind | utterances | share of 5,915 |
|---|---:|---:|
| test fixtures only | 3,964 | 67.0% |
...
**91.5% of everything this project may read — 5,411 of 5,915 — is either a
