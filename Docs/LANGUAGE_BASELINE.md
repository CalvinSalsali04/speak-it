...
| utterances | share of 5,985 | population |
|---:|---:|---|
| 4,148 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,885 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,985, is a
total.
...
114, so the three kinds are 4,148 + 1,333 + 618 = 6,099 against a union of
5,985 and do not add up. Written out so that they do:

| kind | utterances | share of 5,985 |
|---|---:|---:|
| test fixtures only | 4,034 | 67.4% |
...
**91.6% of everything this project may read — 5,481 of 5,985 — is either a
