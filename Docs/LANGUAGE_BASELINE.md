...
| utterances | share of 6,208 | population |
|---:|---:|---|
| 4,371 | 70.4% | the gating corpus in `SpeakItTests` |
| 818 | 13.2% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 11.2% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
| 472 | 7.6% | `Tools/SpeechLab/audit/combined-renderings.jsonl` |
...
**That column sums to 7,108 and its shares to 114.5%, because the twelve
...
additional maximal population that contains it. Only the union, 6,208, is a
total.
...
114, so the three kinds are 4,371 + 1,333 + 618 = 6,322 against a union of
6,208 and do not add up. Written out so that they do:

| kind | utterances | share of 6,208 |
|---|---:|---:|
| test fixtures only | 4,257 | 68.6% |
| generated renderings (the SpeechLab tree) | 1,333 | 21.5% |
| development sets only | 504 | 8.1% |
| in both a development set and a fixture | 114 | 1.8% |
| **total** | **6,208** | |

**91.9% of everything this project may read — 5,704 of 6,208 — is either a
