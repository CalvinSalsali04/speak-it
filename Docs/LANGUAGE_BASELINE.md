...
| utterances | share of 5,916 | population |
|---:|---:|---|
| 4,079 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,816 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,916, is a
total.
...
114, so the three kinds are 4,079 + 1,333 + 618 = 6,030 against a union of
5,916 and do not add up. Written out so that they do:

| kind | utterances | share of 5,916 |
|---|---:|---:|
| test fixtures only | 3,965 | 67.0% |
...
**91.5% of everything this project may read — 5,412 of 5,916 — is either a
