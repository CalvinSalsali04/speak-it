...
| utterances | share of 5,992 | population |
|---:|---:|---|
| 4,155 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,892 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,992, is a
total.
...
114, so the three kinds are 4,155 + 1,333 + 618 = 6,106 against a union of
5,992 and do not add up. Written out so that they do:

| kind | utterances | share of 5,992 |
|---|---:|---:|
| test fixtures only | 4,041 | 67.4% |
...
**91.6% of everything this project may read — 5,488 of 5,992 — is either a
