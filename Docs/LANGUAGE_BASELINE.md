...
| utterances | share of 5,910 | population |
|---:|---:|---|
| 4,073 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,810 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,910, is a
total.
...
114, so the three kinds are 4,073 + 1,333 + 618 = 6,024 against a union of
5,910 and do not add up. Written out so that they do:

| kind | utterances | share of 5,910 |
|---|---:|---:|
| test fixtures only | 3,959 | 67.0% |
...
**91.5% of everything this project may read — 5,406 of 5,910 — is either a
