...
| utterances | share of 6,004 | population |
|---:|---:|---|
| 4,167 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,904 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,004, is a
total.
...
114, so the three kinds are 4,167 + 1,333 + 618 = 6,118 against a union of
6,004 and do not add up. Written out so that they do:

| kind | utterances | share of 6,004 |
|---|---:|---:|
| test fixtures only | 4,053 | 67.5% |
...
**91.6% of everything this project may read — 5,500 of 6,004 — is either a
