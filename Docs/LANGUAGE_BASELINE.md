...
| utterances | share of 6,612 | population |
|---:|---:|---|
| 4,775 | 72.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,512 and its shares to 113.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,612, is a
total.
...
114, so the three kinds are 4,775 + 1,333 + 618 = 6,726 against a union of
6,612 and do not add up. Written out so that they do:

| kind | utterances | share of 6,612 |
|---|---:|---:|
| test fixtures only | 4,661 | 70.5% |
...
**92.4% of everything this project may read — 6,108 of 6,612 — is either a
