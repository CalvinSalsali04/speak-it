...
| utterances | share of 5,914 | population |
|---:|---:|---|
| 4,077 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,814 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,914, is a
total.
...
114, so the three kinds are 4,077 + 1,333 + 618 = 6,028 against a union of
5,914 and do not add up. Written out so that they do:

| kind | utterances | share of 5,914 |
|---|---:|---:|
| test fixtures only | 3,963 | 67.0% |
...
**91.5% of everything this project may read — 5,410 of 5,914 — is either a
