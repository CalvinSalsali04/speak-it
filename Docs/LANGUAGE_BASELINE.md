...
| utterances | share of 5,930 | population |
|---:|---:|---|
| 4,093 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,830 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,930, is a
total.
...
114, so the three kinds are 4,093 + 1,333 + 618 = 6,044 against a union of
5,930 and do not add up. Written out so that they do:

| kind | utterances | share of 5,930 |
|---|---:|---:|
| test fixtures only | 3,979 | 67.1% |
...
**91.5% of everything this project may read — 5,426 of 5,930 — is either a
