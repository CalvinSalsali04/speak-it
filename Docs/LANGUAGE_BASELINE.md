...
| utterances | share of 6,604 | population |
|---:|---:|---|
| 4,767 | 72.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,504 and its shares to 113.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,604, is a
total.
...
114, so the three kinds are 4,767 + 1,333 + 618 = 6,718 against a union of
6,604 and do not add up. Written out so that they do:

| kind | utterances | share of 6,604 |
|---|---:|---:|
| test fixtures only | 4,653 | 70.5% |
...
**92.4% of everything this project may read — 6,100 of 6,604 — is either a
