...
| utterances | share of 5,952 | population |
|---:|---:|---|
| 4,115 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,852 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,952, is a
total.
...
114, so the three kinds are 4,115 + 1,333 + 618 = 6,066 against a union of
5,952 and do not add up. Written out so that they do:

| kind | utterances | share of 5,952 |
|---|---:|---:|
| test fixtures only | 4,001 | 67.2% |
...
**91.5% of everything this project may read — 5,448 of 5,952 — is either a
