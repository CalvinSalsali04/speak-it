...
| utterances | share of 6,610 | population |
|---:|---:|---|
| 4,773 | 72.2% | the gating corpus in `SpeakItTests` |
| 818 | 12.4% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 10.5% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
...
**That column sums to 7,510 and its shares to 113.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,610, is a
total.
...
114, so the three kinds are 4,773 + 1,333 + 618 = 6,724 against a union of
6,610 and do not add up. Written out so that they do:

| kind | utterances | share of 6,610 |
|---|---:|---:|
| test fixtures only | 4,659 | 70.5% |
| generated renderings (the SpeechLab tree) | 1,333 | 20.2% |
| development sets only | 504 | 7.6% |
| in both a development set and a fixture | 114 | 1.7% |
| **total** | **6,610** | |

**92.4% of everything this project may read — 6,106 of 6,610 — is either a
