...
| utterances | share of 5,906 | population |
|---:|---:|---|
| 4,069 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,806 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,906, is a
total.
...
114, so the three kinds are 4,069 + 1,333 + 618 = 6,020 against a union of
5,906 and do not add up. Written out so that they do:

| kind | utterances | share of 5,906 |
|---|---:|---:|
| test fixtures only | 3,955 | 67.0% |
| generated renderings (the SpeechLab tree) | 1,333 | 22.6% |
| development sets only | 504 | 8.5% |
| in both a development set and a fixture | 114 | 1.9% |
| **total** | **5,906** | |

**91.5% of everything this project may read — 5,402 of 5,906 — is either a
