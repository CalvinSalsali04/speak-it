...
| utterances | share of 6,043 | population |
|---:|---:|---|
| 4,206 | 69.6% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,943 and its shares to 114.9%, because the twelve
...
additional maximal population that contains it. Only the union, 6,043, is a
total.
...
114, so the three kinds are 4,206 + 1,333 + 618 = 6,157 against a union of
6,043 and do not add up. Written out so that they do:

| kind | utterances | share of 6,043 |
|---|---:|---:|
| test fixtures only | 4,092 | 67.7% |
...
**91.7% of everything this project may read — 5,539 of 6,043 — is either a
