...
| utterances | share of 6,871 | population |
|---:|---:|---|
| 5,035 | 73.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,772 and its shares to 113.1%, because the twelve
...
additional maximal population that contains it. Only the union, 6,871, is a
total.
...
115, so the three kinds are 5,035 + 1,333 + 618 = 6,986 against a union of
6,871 and do not add up. Written out so that they do:

| kind | utterances | share of 6,871 |
|---|---:|---:|
| test fixtures only | 4,920 | 71.6% |
...
**92.7% of everything this project may read — 6,368 of 6,871 — is either a
