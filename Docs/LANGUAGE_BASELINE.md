...
| utterances | share of 5,947 | population |
|---:|---:|---|
| 4,110 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,847 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,947, is a
total.
...
114, so the three kinds are 4,110 + 1,333 + 618 = 6,061 against a union of
5,947 and do not add up. Written out so that they do:

| kind | utterances | share of 5,947 |
|---|---:|---:|
| test fixtures only | 3,996 | 67.2% |
...
**91.5% of everything this project may read — 5,443 of 5,947 — is either a
