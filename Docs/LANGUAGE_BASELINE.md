...
| utterances | share of 6,347 | population |
|---:|---:|---|
| 4,510 | 71.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,247 and its shares to 114.2%, because the twelve
...
additional maximal population that contains it. Only the union, 6,347, is a
total.
...
114, so the three kinds are 4,510 + 1,333 + 618 = 6,461 against a union of
6,347 and do not add up. Written out so that they do:

| kind | utterances | share of 6,347 |
|---|---:|---:|
| test fixtures only | 4,396 | 69.3% |
| generated renderings (the SpeechLab tree) | 1,333 | 21.0% |
| development sets only | 504 | 7.9% |
| in both a development set and a fixture | 114 | 1.8% |
| **total** | **6,347** | |

**92.1% of everything this project may read — 5,843 of 6,347 — is either a
