...
| utterances | share of 5,958 | population |
|---:|---:|---|
| 4,121 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,858 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,958, is a
total.
...
114, so the three kinds are 4,121 + 1,333 + 618 = 6,072 against a union of
5,958 and do not add up. Written out so that they do:

| kind | utterances | share of 5,958 |
|---|---:|---:|
| test fixtures only | 4,007 | 67.3% |
...
**91.5% of everything this project may read — 5,454 of 5,958 — is either a
