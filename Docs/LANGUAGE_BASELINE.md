...
| utterances | share of 6,865 | population |
|---:|---:|---|
| 5,029 | 73.3% | the gating corpus in `SpeakItTests` |
| 818 | 11.9% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 10.1% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
| 472 | 6.9% | `Tools/SpeechLab/audit/combined-renderings.jsonl` |
...
| 85 | 1.2% | `Tools/CorpusRunner/devsets/rambling.tsv` |
...
**That column sums to 7,766 and its shares to 113.1%, because the twelve
...
additional maximal population that contains it. Only the union, 6,865, is a
total.
...
115, so the three kinds are 5,029 + 1,333 + 618 = 6,980 against a union of
6,865 and do not add up. Written out so that they do:

| kind | utterances | share of 6,865 |
|---|---:|---:|
| test fixtures only | 4,914 | 71.6% |
| generated renderings (the SpeechLab tree) | 1,333 | 19.4% |
| development sets only | 503 | 7.3% |
| in both a development set and a fixture | 115 | 1.7% |
| **total** | **6,865** | |

**92.7% of everything this project may read — 6,362 of 6,865 — is either a
