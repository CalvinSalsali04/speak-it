...
| utterances | share of 5,963 | population |
|---:|---:|---|
| 4,126 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,863 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,963, is a
total.
...
114, so the three kinds are 4,126 + 1,333 + 618 = 6,077 against a union of
5,963 and do not add up. Written out so that they do:

| kind | utterances | share of 5,963 |
|---|---:|---:|
| test fixtures only | 4,012 | 67.3% |
...
**91.5% of everything this project may read — 5,459 of 5,963 — is either a
