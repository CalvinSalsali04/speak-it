...
| utterances | share of 5,993 | population |
|---:|---:|---|
| 4,156 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,893 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,993, is a
total.
...
114, so the three kinds are 4,156 + 1,333 + 618 = 6,107 against a union of
5,993 and do not add up. Written out so that they do:

| kind | utterances | share of 5,993 |
|---|---:|---:|
| test fixtures only | 4,042 | 67.4% |
...
**91.6% of everything this project may read — 5,489 of 5,993 — is either a
