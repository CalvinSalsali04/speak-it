...
| utterances | share of 6,634 | population |
|---:|---:|---|
| 4,797 | 72.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,534 and its shares to 113.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,634, is a
total.
...
114, so the three kinds are 4,797 + 1,333 + 618 = 6,748 against a union of
6,634 and do not add up. Written out so that they do:

| kind | utterances | share of 6,634 |
|---|---:|---:|
| test fixtures only | 4,683 | 70.6% |
...
**92.4% of everything this project may read — 6,130 of 6,634 — is either a
