...
| utterances | share of 5,965 | population |
|---:|---:|---|
| 4,128 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,865 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,965, is a
total.
...
114, so the three kinds are 4,128 + 1,333 + 618 = 6,079 against a union of
5,965 and do not add up. Written out so that they do:

| kind | utterances | share of 5,965 |
|---|---:|---:|
| test fixtures only | 4,014 | 67.3% |
...
**91.6% of everything this project may read — 5,461 of 5,965 — is either a
