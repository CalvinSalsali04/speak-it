...
| utterances | share of 5,973 | population |
|---:|---:|---|
| 4,136 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,873 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,973, is a
total.
...
114, so the three kinds are 4,136 + 1,333 + 618 = 6,087 against a union of
5,973 and do not add up. Written out so that they do:

| kind | utterances | share of 5,973 |
|---|---:|---:|
| test fixtures only | 4,022 | 67.3% |
...
**91.6% of everything this project may read — 5,469 of 5,973 — is either a
