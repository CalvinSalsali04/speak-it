...
| utterances | share of 5,955 | population |
|---:|---:|---|
| 4,118 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,855 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,955, is a
total.
...
114, so the three kinds are 4,118 + 1,333 + 618 = 6,069 against a union of
5,955 and do not add up. Written out so that they do:

| kind | utterances | share of 5,955 |
|---|---:|---:|
| test fixtures only | 4,004 | 67.2% |
...
**91.5% of everything this project may read — 5,451 of 5,955 — is either a
