...
| utterances | share of 5,921 | population |
|---:|---:|---|
| 4,084 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,821 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,921, is a
total.
...
114, so the three kinds are 4,084 + 1,333 + 618 = 6,035 against a union of
5,921 and do not add up. Written out so that they do:

| kind | utterances | share of 5,921 |
|---|---:|---:|
| test fixtures only | 3,970 | 67.0% |
...
**91.5% of everything this project may read — 5,417 of 5,921 — is either a
