...
| utterances | share of 6,029 | population |
|---:|---:|---|
| 4,192 | 69.5% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,929 and its shares to 114.9%, because the twelve
...
additional maximal population that contains it. Only the union, 6,029, is a
total.
...
114, so the three kinds are 4,192 + 1,333 + 618 = 6,143 against a union of
6,029 and do not add up. Written out so that they do:

| kind | utterances | share of 6,029 |
|---|---:|---:|
| test fixtures only | 4,078 | 67.6% |
...
**91.6% of everything this project may read — 5,525 of 6,029 — is either a
