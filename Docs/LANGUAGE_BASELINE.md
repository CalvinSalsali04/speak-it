...
| utterances | share of 5,987 | population |
|---:|---:|---|
| 4,150 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,887 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,987, is a
total.
...
114, so the three kinds are 4,150 + 1,333 + 618 = 6,101 against a union of
5,987 and do not add up. Written out so that they do:

| kind | utterances | share of 5,987 |
|---|---:|---:|
| test fixtures only | 4,036 | 67.4% |
...
**91.6% of everything this project may read — 5,483 of 5,987 — is either a
