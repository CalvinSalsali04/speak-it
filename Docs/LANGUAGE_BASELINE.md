...
| utterances | share of 5,999 | population |
|---:|---:|---|
| 4,162 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,899 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,999, is a
total.
...
114, so the three kinds are 4,162 + 1,333 + 618 = 6,113 against a union of
5,999 and do not add up. Written out so that they do:

| kind | utterances | share of 5,999 |
|---|---:|---:|
| test fixtures only | 4,048 | 67.5% |
...
**91.6% of everything this project may read — 5,495 of 5,999 — is either a
