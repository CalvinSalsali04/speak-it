...
| utterances | share of 5,961 | population |
|---:|---:|---|
| 4,124 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,861 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,961, is a
total.
...
114, so the three kinds are 4,124 + 1,333 + 618 = 6,075 against a union of
5,961 and do not add up. Written out so that they do:

| kind | utterances | share of 5,961 |
|---|---:|---:|
| test fixtures only | 4,010 | 67.3% |
...
**91.5% of everything this project may read — 5,457 of 5,961 — is either a
