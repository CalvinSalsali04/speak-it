...
| utterances | share of 5,953 | population |
|---:|---:|---|
| 4,116 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,853 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,953, is a
total.
...
114, so the three kinds are 4,116 + 1,333 + 618 = 6,067 against a union of
5,953 and do not add up. Written out so that they do:

| kind | utterances | share of 5,953 |
|---|---:|---:|
| test fixtures only | 4,002 | 67.2% |
...
**91.5% of everything this project may read — 5,449 of 5,953 — is either a
