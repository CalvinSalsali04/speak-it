...
| utterances | share of 6,021 | population |
|---:|---:|---|
| 4,184 | 69.5% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,921 and its shares to 114.9%, because the twelve
...
additional maximal population that contains it. Only the union, 6,021, is a
total.
...
114, so the three kinds are 4,184 + 1,333 + 618 = 6,135 against a union of
6,021 and do not add up. Written out so that they do:

| kind | utterances | share of 6,021 |
|---|---:|---:|
| test fixtures only | 4,070 | 67.6% |
...
**91.6% of everything this project may read — 5,517 of 6,021 — is either a
