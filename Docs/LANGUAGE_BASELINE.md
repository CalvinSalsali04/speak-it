...
| utterances | share of 6,015 | population |
|---:|---:|---|
| 4,178 | 69.5% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,915 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,015, is a
total.
...
114, so the three kinds are 4,178 + 1,333 + 618 = 6,129 against a union of
6,015 and do not add up. Written out so that they do:

| kind | utterances | share of 6,015 |
|---|---:|---:|
| test fixtures only | 4,064 | 67.6% |
...
**91.6% of everything this project may read — 5,511 of 6,015 — is either a
