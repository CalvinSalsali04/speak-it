...
| utterances | share of 5,923 | population |
|---:|---:|---|
| 4,086 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,823 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,923, is a
total.
...
114, so the three kinds are 4,086 + 1,333 + 618 = 6,037 against a union of
5,923 and do not add up. Written out so that they do:

| kind | utterances | share of 5,923 |
|---|---:|---:|
| test fixtures only | 3,972 | 67.1% |
...
**91.5% of everything this project may read — 5,419 of 5,923 — is either a
