...
| utterances | share of 6,072 | population |
|---:|---:|---|
| 4,235 | 69.7% | the gating corpus in `SpeakItTests` |
| 818 | 13.5% | `Tools/SpeechLab/phase2`, in four byte-identical files |
...
**That column sums to 6,972 and its shares to 114.8%, because the twelve
...
additional maximal population that contains it. Only the union, 6,072, is a
total.
...
114, so the three kinds are 4,235 + 1,333 + 618 = 6,186 against a union of
6,072 and do not add up. Written out so that they do:

| kind | utterances | share of 6,072 |
|---|---:|---:|
| test fixtures only | 4,121 | 67.9% |
| generated renderings (the SpeechLab tree) | 1,333 | 22.0% |
| development sets only | 504 | 8.3% |
| in both a development set and a fixture | 114 | 1.9% |
| **total** | **6,072** | |

**91.7% of everything this project may read — 5,568 of 6,072 — is either a
