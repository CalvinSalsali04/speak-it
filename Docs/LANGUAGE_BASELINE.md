...
| utterances | share of 5,596 | population |
|---:|---:|---|
| 3,755 | 67.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,492 and its shares to 116.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,596, is a
total.
...
110, so the three kinds are 3,755 + 1,333 + 618 = 5,706 against a union of
5,596 and do not add up. Written out so that they do:

| kind | utterances | share of 5,596 |
|---|---:|---:|
| test fixtures only | 3,645 | 65.1% |
...
**90.9% of everything this project may read — 5,088 of 5,596 — is either a
