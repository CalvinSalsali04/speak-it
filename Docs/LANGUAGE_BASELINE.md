...
| utterances | share of 5,907 | population |
|---:|---:|---|
| 4,070 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,807 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,907, is a
total.
...
114, so the three kinds are 4,070 + 1,333 + 618 = 6,021 against a union of
5,907 and do not add up. Written out so that they do:

| kind | utterances | share of 5,907 |
|---|---:|---:|
| test fixtures only | 3,956 | 67.0% |
...
**91.5% of everything this project may read — 5,403 of 5,907 — is either a
