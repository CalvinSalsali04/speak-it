...
| utterances | share of 5,908 | population |
|---:|---:|---|
| 4,071 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,808 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,908, is a
total.
...
114, so the three kinds are 4,071 + 1,333 + 618 = 6,022 against a union of
5,908 and do not add up. Written out so that they do:

| kind | utterances | share of 5,908 |
|---|---:|---:|
| test fixtures only | 3,957 | 67.0% |
...
**91.5% of everything this project may read — 5,404 of 5,908 — is either a
