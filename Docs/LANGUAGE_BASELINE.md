...
| utterances | share of 5,919 | population |
|---:|---:|---|
| 4,082 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,819 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,919, is a
total.
...
114, so the three kinds are 4,082 + 1,333 + 618 = 6,033 against a union of
5,919 and do not add up. Written out so that they do:

| kind | utterances | share of 5,919 |
|---|---:|---:|
| test fixtures only | 3,968 | 67.0% |
...
**91.5% of everything this project may read — 5,415 of 5,919 — is either a
