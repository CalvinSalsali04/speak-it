...
| utterances | share of 5,966 | population |
|---:|---:|---|
| 4,129 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,866 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,966, is a
total.
...
114, so the three kinds are 4,129 + 1,333 + 618 = 6,080 against a union of
5,966 and do not add up. Written out so that they do:

| kind | utterances | share of 5,966 |
|---|---:|---:|
| test fixtures only | 4,015 | 67.3% |
...
**91.6% of everything this project may read — 5,462 of 5,966 — is either a
