...
| utterances | share of 6,773 | population |
|---:|---:|---|
| 4,937 | 72.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,674 and its shares to 113.3%, because the twelve
...
additional maximal population that contains it. Only the union, 6,773, is a
total.
...
115, so the three kinds are 4,937 + 1,333 + 618 = 6,888 against a union of
6,773 and do not add up. Written out so that they do:

| kind | utterances | share of 6,773 |
|---|---:|---:|
| test fixtures only | 4,822 | 71.2% |
...
**92.6% of everything this project may read — 6,270 of 6,773 — is either a
