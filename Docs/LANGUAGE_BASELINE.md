...
| utterances | share of 5,922 | population |
|---:|---:|---|
| 4,085 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,822 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,922, is a
total.
...
114, so the three kinds are 4,085 + 1,333 + 618 = 6,036 against a union of
5,922 and do not add up. Written out so that they do:

| kind | utterances | share of 5,922 |
|---|---:|---:|
| test fixtures only | 3,971 | 67.1% |
...
**91.5% of everything this project may read — 5,418 of 5,922 — is either a
