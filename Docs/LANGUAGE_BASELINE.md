...
| utterances | share of 5,943 | population |
|---:|---:|---|
| 4,107 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,844 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,943, is a
total.
...
115, so the three kinds are 4,107 + 1,333 + 618 = 6,058 against a union of
5,943 and do not add up. Written out so that they do:

| kind | utterances | share of 5,943 |
|---|---:|---:|
| test fixtures only | 3,992 | 67.2% |
...
**91.5% of everything this project may read — 5,440 of 5,943 — is either a
