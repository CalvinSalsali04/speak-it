...
| utterances | share of 5,977 | population |
|---:|---:|---|
| 4,140 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,877 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,977, is a
total.
...
114, so the three kinds are 4,140 + 1,333 + 618 = 6,091 against a union of
5,977 and do not add up. Written out so that they do:

| kind | utterances | share of 5,977 |
|---|---:|---:|
| test fixtures only | 4,026 | 67.4% |
...
**91.6% of everything this project may read — 5,473 of 5,977 — is either a
