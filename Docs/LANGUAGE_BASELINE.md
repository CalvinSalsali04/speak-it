...
| utterances | share of 5,990 | population |
|---:|---:|---|
| 4,153 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,890 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,990, is a
total.
...
114, so the three kinds are 4,153 + 1,333 + 618 = 6,104 against a union of
5,990 and do not add up. Written out so that they do:

| kind | utterances | share of 5,990 |
|---|---:|---:|
| test fixtures only | 4,039 | 67.4% |
...
**91.6% of everything this project may read — 5,486 of 5,990 — is either a
