...
| utterances | share of 6,322 | population |
|---:|---:|---|
| 4,485 | 70.9% | the gating corpus in `SpeakItTests` |
| 818 | 12.9% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 11.0% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
| 472 | 7.5% | `Tools/SpeechLab/audit/combined-renderings.jsonl` |
| 163 | 2.6% | `Tools/CorpusRunner/devsets/unfinished.tsv` |
...
**That column sums to 7,222 and its shares to 114.2%, because the twelve
...
additional maximal population that contains it. Only the union, 6,322, is a
total.
...
114, so the three kinds are 4,485 + 1,333 + 618 = 6,436 against a union of
6,322 and do not add up. Written out so that they do:

| kind | utterances | share of 6,322 |
|---|---:|---:|
| test fixtures only | 4,371 | 69.1% |
| generated renderings (the SpeechLab tree) | 1,333 | 21.1% |
| development sets only | 504 | 8.0% |
| in both a development set and a fixture | 114 | 1.8% |
| **total** | **6,322** | |

**92.0% of everything this project may read — 5,818 of 6,322 — is either a
