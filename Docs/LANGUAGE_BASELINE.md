...
| utterances | share of 5,927 | population |
|---:|---:|---|
| 4,090 | 69.0% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,827 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,927, is a
total.
...
114, so the three kinds are 4,090 + 1,333 + 618 = 6,041 against a union of
5,927 and do not add up. Written out so that they do:

| kind | utterances | share of 5,927 |
|---|---:|---:|
| test fixtures only | 3,976 | 67.1% |
...
**91.5% of everything this project may read — 5,423 of 5,927 — is either a
