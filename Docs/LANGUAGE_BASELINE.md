...
| utterances | share of 5,941 | population |
|---:|---:|---|
| 4,105 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,842 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,941, is a
total.
...
115, so the three kinds are 4,105 + 1,333 + 618 = 6,056 against a union of
5,941 and do not add up. Written out so that they do:

| kind | utterances | share of 5,941 |
|---|---:|---:|
| test fixtures only | 3,990 | 67.2% |
...
**91.5% of everything this project may read — 5,438 of 5,941 — is either a
