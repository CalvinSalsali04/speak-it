...
| utterances | share of 6,769 | population |
|---:|---:|---|
| 4,933 | 72.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,670 and its shares to 113.3%, because the twelve
...
additional maximal population that contains it. Only the union, 6,769, is a
total.
...
115, so the three kinds are 4,933 + 1,333 + 618 = 6,884 against a union of
6,769 and do not add up. Written out so that they do:

| kind | utterances | share of 6,769 |
|---|---:|---:|
| test fixtures only | 4,818 | 71.2% |
...
**92.6% of everything this project may read — 6,266 of 6,769 — is either a
