...
| utterances | share of 5,971 | population |
|---:|---:|---|
| 4,134 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,871 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,971, is a
total.
...
114, so the three kinds are 4,134 + 1,333 + 618 = 6,085 against a union of
5,971 and do not add up. Written out so that they do:

| kind | utterances | share of 5,971 |
|---|---:|---:|
| test fixtures only | 4,020 | 67.3% |
...
**91.6% of everything this project may read — 5,467 of 5,971 — is either a
