...
| utterances | share of 6,013 | population |
|---:|---:|---|
| 4,176 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,913 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,013, is a
total.
...
114, so the three kinds are 4,176 + 1,333 + 618 = 6,127 against a union of
6,013 and do not add up. Written out so that they do:

| kind | utterances | share of 6,013 |
|---|---:|---:|
| test fixtures only | 4,062 | 67.6% |
...
**91.6% of everything this project may read — 5,509 of 6,013 — is either a
