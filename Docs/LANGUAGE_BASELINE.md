...
| utterances | share of 5,988 | population |
|---:|---:|---|
| 4,151 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,888 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,988, is a
total.
...
114, so the three kinds are 4,151 + 1,333 + 618 = 6,102 against a union of
5,988 and do not add up. Written out so that they do:

| kind | utterances | share of 5,988 |
|---|---:|---:|
| test fixtures only | 4,037 | 67.4% |
...
**91.6% of everything this project may read — 5,484 of 5,988 — is either a
