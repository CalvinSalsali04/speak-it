...
| utterances | share of 5,956 | population |
|---:|---:|---|
| 4,119 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,856 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,956, is a
total.
...
114, so the three kinds are 4,119 + 1,333 + 618 = 6,070 against a union of
5,956 and do not add up. Written out so that they do:

| kind | utterances | share of 5,956 |
|---|---:|---:|
| test fixtures only | 4,005 | 67.2% |
...
**91.5% of everything this project may read — 5,452 of 5,956 — is either a
