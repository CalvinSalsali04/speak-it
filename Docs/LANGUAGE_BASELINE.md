...
| utterances | share of 5,944 | population |
|---:|---:|---|
...
**That column sums to 6,844 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,944, is a
total.
...
114, so the three kinds are 4,107 + 1,333 + 618 = 6,058 against a union of
5,944 and do not add up. Written out so that they do:

| kind | utterances | share of 5,944 |
|---|---:|---:|
| test fixtures only | 3,993 | 67.2% |
...
**91.5% of everything this project may read — 5,440 of 5,944 — is either a
