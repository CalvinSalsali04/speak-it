...
| utterances | share of 5,975 | population |
|---:|---:|---|
| 4,138 | 69.3% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,875 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,975, is a
total.
...
114, so the three kinds are 4,138 + 1,333 + 618 = 6,089 against a union of
5,975 and do not add up. Written out so that they do:

| kind | utterances | share of 5,975 |
|---|---:|---:|
| test fixtures only | 4,024 | 67.3% |
...
**91.6% of everything this project may read — 5,471 of 5,975 — is either a
