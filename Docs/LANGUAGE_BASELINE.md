...
| utterances | share of 5,998 | population |
|---:|---:|---|
| 4,161 | 69.4% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,898 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 5,998, is a
total.
...
114, so the three kinds are 4,161 + 1,333 + 618 = 6,112 against a union of
5,998 and do not add up. Written out so that they do:

| kind | utterances | share of 5,998 |
|---|---:|---:|
| test fixtures only | 4,047 | 67.5% |
...
**91.6% of everything this project may read — 5,494 of 5,998 — is either a
