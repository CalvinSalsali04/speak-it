...
| utterances | share of 6,016 | population |
|---:|---:|---|
| 4,179 | 69.5% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,916 and its shares to 115.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,016, is a
total.
...
114, so the three kinds are 4,179 + 1,333 + 618 = 6,130 against a union of
6,016 and do not add up. Written out so that they do:

| kind | utterances | share of 6,016 |
|---|---:|---:|
| test fixtures only | 4,065 | 67.6% |
...
**91.6% of everything this project may read — 5,512 of 6,016 — is either a
