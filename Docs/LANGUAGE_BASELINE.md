...
| utterances | share of 6,615 | population |
|---:|---:|---|
| 4,778 | 72.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,515 and its shares to 113.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,615, is a
total.
...
114, so the three kinds are 4,778 + 1,333 + 618 = 6,729 against a union of
6,615 and do not add up. Written out so that they do:

| kind | utterances | share of 6,615 |
|---|---:|---:|
| test fixtures only | 4,664 | 70.5% |
...
**92.4% of everything this project may read — 6,111 of 6,615 — is either a
