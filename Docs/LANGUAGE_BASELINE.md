...
| utterances | share of 6,160 | population |
|---:|---:|---|
| 4,323 | 70.2% | the gating corpus in `SpeakItTests` |
| 818 | 13.3% | `Tools/SpeechLab/phase2`, in four byte-identical files |
| 695 | 11.3% | `Tools/SpeechLab/phase2/repair/trust-closure/cases.jsonl` |
| 472 | 7.7% | `Tools/SpeechLab/audit/combined-renderings.jsonl` |
...
**That column sums to 7,060 and its shares to 114.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,160, is a
total.
...
114, so the three kinds are 4,323 + 1,333 + 618 = 6,274 against a union of
6,160 and do not add up. Written out so that they do:

| kind | utterances | share of 6,160 |
|---|---:|---:|
| test fixtures only | 4,209 | 68.3% |
...
**91.8% of everything this project may read — 5,656 of 6,160 — is either a
