...
| utterances | share of 6,060 | population |
|---:|---:|---|
| 4,223 | 69.7% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,960 and its shares to 114.9%, because the twelve
...
additional maximal population that contains it. Only the union, 6,060, is a
total.
...
114, so the three kinds are 4,223 + 1,333 + 618 = 6,174 against a union of
6,060 and do not add up. Written out so that they do:

| kind | utterances | share of 6,060 |
|---|---:|---:|
| test fixtures only | 4,109 | 67.8% |
...
**91.7% of everything this project may read — 5,556 of 6,060 — is either a
