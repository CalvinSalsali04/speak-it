...
| utterances | share of 5,912 | population |
|---:|---:|---|
| 4,075 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,812 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,912, is a
total.
...
114, so the three kinds are 4,075 + 1,333 + 618 = 6,026 against a union of
5,912 and do not add up. Written out so that they do:

| kind | utterances | share of 5,912 |
|---|---:|---:|
| test fixtures only | 3,961 | 67.0% |
...
**91.5% of everything this project may read — 5,408 of 5,912 — is either a
