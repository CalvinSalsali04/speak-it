...
| utterances | share of 6,156 | population |
|---:|---:|---|
| 4,319 | 70.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,056 and its shares to 114.6%, because the twelve
...
additional maximal population that contains it. Only the union, 6,156, is a
total.
...
114, so the three kinds are 4,319 + 1,333 + 618 = 6,270 against a union of
6,156 and do not add up. Written out so that they do:

| kind | utterances | share of 6,156 |
|---|---:|---:|
| test fixtures only | 4,205 | 68.3% |
| generated renderings (the SpeechLab tree) | 1,333 | 21.7% |
| development sets only | 504 | 8.2% |
| in both a development set and a fixture | 114 | 1.9% |
| **total** | **6,156** | |

**91.8% of everything this project may read — 5,652 of 6,156 — is either a
