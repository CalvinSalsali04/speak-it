...
| utterances | share of 6,777 | population |
|---:|---:|---|
| 4,941 | 72.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,678 and its shares to 113.3%, because the twelve
...
additional maximal population that contains it. Only the union, 6,777, is a
total.
...
115, so the three kinds are 4,941 + 1,333 + 618 = 6,892 against a union of
6,777 and do not add up. Written out so that they do:

| kind | utterances | share of 6,777 |
|---|---:|---:|
| test fixtures only | 4,826 | 71.2% |
...
**92.6% of everything this project may read — 6,274 of 6,777 — is either a
