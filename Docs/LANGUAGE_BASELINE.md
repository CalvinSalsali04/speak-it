...
| utterances | share of 6,407 | population |
|---:|---:|---|
| 4,570 | 71.3% | the gating corpus in `SpeakItTests` |
| 818 | 12.8% | `Tools/SpeechLab/phase2`, in four byte-identical files |
...
**That column sums to 7,307 and its shares to 114.0%, because the twelve
...
additional maximal population that contains it. Only the union, 6,407, is a
total.
...
114, so the three kinds are 4,570 + 1,333 + 618 = 6,521 against a union of
6,407 and do not add up. Written out so that they do:

| kind | utterances | share of 6,407 |
|---|---:|---:|
| test fixtures only | 4,456 | 69.5% |
...
**92.1% of everything this project may read — 5,903 of 6,407 — is either a
