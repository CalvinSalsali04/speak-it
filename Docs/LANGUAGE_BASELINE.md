...
| utterances | share of 5,969 | population |
|---:|---:|---|
| 4,132 | 69.2% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,869 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,969, is a
total.
...
114, so the three kinds are 4,132 + 1,333 + 618 = 6,083 against a union of
5,969 and do not add up. Written out so that they do:

| kind | utterances | share of 5,969 |
|---|---:|---:|
| test fixtures only | 4,018 | 67.3% |
...
**91.6% of everything this project may read — 5,465 of 5,969 — is either a
