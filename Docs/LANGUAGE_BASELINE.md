...
| utterances | share of 5,937 | population |
|---:|---:|---|
| 4,100 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,837 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,937, is a
total.
...
114, so the three kinds are 4,100 + 1,333 + 618 = 6,051 against a union of
5,937 and do not add up. Written out so that they do:

| kind | utterances | share of 5,937 |
|---|---:|---:|
| test fixtures only | 3,986 | 67.1% |
...
**91.5% of everything this project may read — 5,433 of 5,937 — is either a
