...
| utterances | share of 5,954 | population |
|---:|---:|---|
| 4,117 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,854 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,954, is a
total.
...
114, so the three kinds are 4,117 + 1,333 + 618 = 6,068 against a union of
5,954 and do not add up. Written out so that they do:

| kind | utterances | share of 5,954 |
|---|---:|---:|
| test fixtures only | 4,003 | 67.2% |
...
**91.5% of everything this project may read — 5,450 of 5,954 — is either a
