...
| utterances | share of 5,948 | population |
|---:|---:|---|
| 4,111 | 69.1% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,848 and its shares to 115.1%, because the twelve
...
additional maximal population that contains it. Only the union, 5,948, is a
total.
...
114, so the three kinds are 4,111 + 1,333 + 618 = 6,062 against a union of
5,948 and do not add up. Written out so that they do:

| kind | utterances | share of 5,948 |
|---|---:|---:|
| test fixtures only | 3,997 | 67.2% |
...
**91.5% of everything this project may read — 5,444 of 5,948 — is either a
