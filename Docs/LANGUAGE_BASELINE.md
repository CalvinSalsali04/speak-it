...
| utterances | share of 6,722 | population |
|---:|---:|---|
| 4,886 | 72.7% | the gating corpus in `SpeakItTests` |
...
**That column sums to 7,623 and its shares to 113.4%, because the twelve
...
additional maximal population that contains it. Only the union, 6,722, is a
total.
...
115, so the three kinds are 4,886 + 1,333 + 618 = 6,837 against a union of
6,722 and do not add up. Written out so that they do:

| kind | utterances | share of 6,722 |
|---|---:|---:|
| test fixtures only | 4,771 | 71.0% |
...
**92.5% of everything this project may read — 6,219 of 6,722 — is either a
