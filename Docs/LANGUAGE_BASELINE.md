...
| utterances | share of 5,913 | population |
|---:|---:|---|
| 4,076 | 68.9% | the gating corpus in `SpeakItTests` |
...
**That column sums to 6,813 and its shares to 115.2%, because the twelve
...
additional maximal population that contains it. Only the union, 5,913, is a
total.
...
114, so the three kinds are 4,076 + 1,333 + 618 = 6,027 against a union of
5,913 and do not add up. Written out so that they do:

| kind | utterances | share of 5,913 |
|---|---:|---:|
| test fixtures only | 3,962 | 67.0% |
...
**91.5% of everything this project may read — 5,409 of 5,913 — is either a
