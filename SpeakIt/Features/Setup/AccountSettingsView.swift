            ...
            List {
                Section {
                    ...
                    if hasProfile {
                        ...
                        Button {
                            ...
                            Label("Create your account", systemImage: "person.crop.circle.badge.plus")
                        }
                    }
                }
                ...
                Section {
                    ShareLink(
                        ...
                        Label("Share Speak It with a friend", systemImage: "square.and.arrow.up")
                    }
                }
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text(hasProfile ? "Your profile" : "Create your account")
                } footer: {
                ...
                Section {
                    Button(hasProfile ? "Save changes" : "Create account") {
            ...
            .scrollContentBackground(.hidden)
            .background(Color.speakBackground)
            .navigationTitle(hasProfile ? "Edit Profile" : "Create Account")
            .navigationBarTitleDisplayMode(.inline)
            .toolbar {
