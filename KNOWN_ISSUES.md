...
Today's collapsed disclosure sections were fixed by not building their rows while closed (`TodayDisclosureContent` in `SpeakIt/Features/Today/TodayView.swift`), which is the only mechanism observed to work.
