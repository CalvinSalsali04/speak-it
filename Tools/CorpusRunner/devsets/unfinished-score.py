...
if stats["limited"]:
    ...
    if limits_passing:
        ...
        print("  ← the declaration is stale, not the parser. The gap closed")
        print("    and the declaration did not. Re-read the source it cites")
        print("    and remove the ids that no longer belong, or this set goes")
        print("    on understating what the parser does.")
print()
