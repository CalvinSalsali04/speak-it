...
enum SemanticCorpusA {
    ...
    static let multipleThoughts: [CorpusCase] = [
        ...
        corpusCase(.multipleThoughts, "Buy milk eggs and bananas", count: 1, type: [.shopping],
                   note: "A grocery list is one shopping item, not three."),
        corpusCase(.multipleThoughts, "Buy milk and bread", count: 1, type: [.shopping]),
