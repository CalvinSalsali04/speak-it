...
enum SemanticCorpusE {
    ...
    static let consolidation: [CorpusCase] = [
        ...
        corpusCase(.consolidation, "Buy milk, eggs and bread", count: 1, type: [.shopping],
                   note: "A list of objects is one intention. It was already, and it stays so for the same reason."),
